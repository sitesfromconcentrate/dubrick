const propertyData = {
    "highland-plaza": {
        ...
        stats: [
            { label: "Square Footage", value: "45,000 sq ft" },
            { label: "Year Built", value: "1998" },
            { label: "Units", value: "12 Retail" },
            { label: "Parking", value: "150 Spots" }
        ]
    },
    "the-frederick": {
        title: "The Frederick",
        ...
        stats: [
            { label: "Units", value: "210 Suites" },
            { label: "Year Built", value: "2015" },
            { label: "Type", value: "Condominium" },
            { label: "Status", value: "Fully Leased" }
        ]
    },
    "iron-horse": {
        ...
        stats: [
            { label: "Square Footage", value: "120,000 sq ft" },
            { label: "Ceiling Height", value: "24 ft Clear" },
            { label: "Loading", value: "12 Docks" },
            { label: "Zoning", value: "M-2 Industrial" }
        ]
    },
    "westmount-towers": {
    ...
    "king-street-lofts": {
        ...
        stats: [
            { label: "Commercial", value: "5 Units" },
            { label: "Residential", value: "24 Lofts" },
            { label: "Ceiling Height", value: "14 ft" },
            { label: "Status", value: "Waitlist Only" }
        ]
    },
    "tech-town-commons": {
        ...
        stats: [
            { label: "Leasable Area", value: "85,000 sq ft" },
            { label: "Tenants", value: "Tech / R&D" },
            { label: "Certifications", value: "LEED Silver" },
    ...
    "grand-river-medical": {
        ...
        stats: [
            { label: "Square Footage", value: "60,000 sq ft" },
            { label: "Tenants", value: "15 Clinics" },
            { label: "Year Built", value: "2019" },
            { label: "Parking", value: "Paid Gated" }
        ]
    },
    "riverview-townhomes": {
        ...
        stats: [
            { label: "Units", value: "45 Towns" },
            { label: "Type", value: "Rental Complex" },
            { label: "Occupancy", value: "98%" },
            { label: "Management", value: "Full Service" }
        ]
    }
};